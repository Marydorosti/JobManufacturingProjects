# -*- coding: utf-8 -*-
"""
Created on Sat Jan 15 11:55:21 2022
...
#############################################################################################             
               ...
               #for P in p:
                      ...
                      for i in range(len(graph1)):
                         for j in range(len(graph2[0])):
                               B.append(abs(graph1[i][j] - graph2[i][j]))
           ...
           return violations,B,N,sumCol,graph1,H,g,S,x,y,c
...
############################*******GET_COST******#############################################3##         
    ...
    def GET_COST(self,attr_fltList):
             ...
             return deviceViolations,-violations,sum_of_column_violaton,get_Variety_violation,sum
             #return 100
